...
- [Overview](#overview)
  ...
  - [Protocol Parameters and Constants](#protocol-parameters-and-constants)
...
The following table gives an overview of some protocol parameters and constants, and how they are
affected by protocol upgrades.

| Parameter/Constant | Bedrock (default) value | Latest (default value) | Changes |
| ------------------ | ----------------------- | ---------------------- | ------- |
| `max_sequencer_drift` | 600 | 1800 | [Fjord](../fjord/derivation.md#constant-maximum-sequencer-drift) |
